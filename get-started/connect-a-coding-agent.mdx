...
Write that file when the agent must see env the background daemon does not inherit from your shell, or when you want a non-catalog ACP command. Details: [agents.json](/reference/agents-json).
