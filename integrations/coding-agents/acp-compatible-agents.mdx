...
New catalog entries ship with daemon releases. Prefer agents that already appear in `gpr discover` over hand-rolled launch configs unless you know you need a custom agent spec.
