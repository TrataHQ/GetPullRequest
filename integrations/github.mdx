...
GitHub is a code-host enrichment. GPR works without it for local agent runs; connect it when you want host PRs and issue sync.

[GitLab](/integrations/gitlab) is a peer option. You can connect either or both.
