...
## GitHub PR or GitLab MR not opening

Confirm the matching host (GitHub or GitLab) is connected under **Settings → Connections** and the workspace repo is bound. Local commits can still exist on the machine without a host PR or MR.
