...
A **task** is a unit of work on the kanban board. It can be created in-app or synced from GitHub, GitLab, Jira, or Slack.

## Identity

- Internal id: `tsk_*`
- Display id: human-facing label such as `TRA-1`
- Optional `source_provider`: `github`, `gitlab`, `jira`, or `slack`
