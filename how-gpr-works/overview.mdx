...
| [Pull request](/how-gpr-works/pull-requests) | Review artifact; GitHub is source of truth when connected |
...
[GitHub](/integrations/github), [Jira](/integrations/jira), and [Slack](/integrations/slack) are optional enrichments. They sync issues, open host PRs, and add metadata. They never replace local git results.
